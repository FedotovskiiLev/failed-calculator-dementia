export const COMMAND_CATALOG = [
  ...
  { name:"det", template:"det([[1,2],[3,4]])", category:"matrix", ru:"определитель матрицы", en:"matrix determinant" },
  { name:"inverse", template:"inverse([[1,2],[3,4]])", category:"matrix", ru:"обратная матрица", en:"inverse matrix" },
  { name:"transpose", template:"transpose([[1,2,3],[4,5,6]])", category:"matrix", ru:"транспонировать матрицу", en:"transpose matrix" },
  { name:"matmul", template:"matmul([[1,2],[3,4]],[[5,6],[7,8]])", category:"matrix", ru:"умножить матрицы", en:"multiply matrices" },
  { name:"rank", template:"rank([[1,2],[2,4]])", category:"matrix", ru:"ранг матрицы", en:"matrix rank" },
  { name:"trace", template:"trace([[1,2],[3,4]])", category:"matrix", ru:"след матрицы", en:"matrix trace" },
  { name:"eigen2", template:"eigen2([[2,1],[1,2]])", category:"matrix", ru:"собственные значения матрицы 2×2", en:"2x2 eigenvalues" },
  { name:"dot", template:"dot([1,2,3],[4,5,6])", category:"vector", ru:"скалярное произведение", en:"dot product" },
...
export function activeWord(
  ...
  const left =
    String(source).slice(0, caret);

  const match =
    left.match(/([A-Za-z_][A-Za-z0-9_]*)$/);
